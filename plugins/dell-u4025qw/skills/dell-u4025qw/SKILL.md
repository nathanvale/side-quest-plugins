...
4. Check verified-intel.md for any previously confirmed similar issues
...
For accepted hashes:
```bash
bunx @side-quest/community-intel-cache review --cache-dir "${CLAUDE_PLUGIN_ROOT}/skills/dell-u4025qw/cache" --hashes hash1,hash2,... --decision accepted
```

For rejected hashes:
```bash
bunx @side-quest/community-intel-cache review --cache-dir "${CLAUDE_PLUGIN_ROOT}/skills/dell-u4025qw/cache" --hashes hash1,hash2,... --decision rejected
```
